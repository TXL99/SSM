    ...
    <script type="text/javascript">
		 $(document).ready(function(){
		 	...
		 	$("#zh").blur(function(){
		 		...
		 		var zh=$(this).val();
		 		//2发送到后台servlet查询是否占用
		 		$.getJSON('<%=path%>/zhajax.action','zh='+zh,function(abc){
		 			alert(abc.msg);
		 		});
		 	});
...
<div class="log_bg">	
    <div class="top">
	 ...
	 <div class="regist">
		...
		<div class="reg_c">
        	<fm:form id="reg_frm" action="${pageContext.request.contextPath}/regist.action" modelAttribute="easybuy_user" method="post">
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
              	<td width="95">&nbsp;</td>
                <td>
                	<span class="fl" style="font-size:24px;">注册</span>
                    <span class="fr"><font style="color: red">${ts}</font> &nbsp 已有商城账号，<a href="Login.html" style="color:#ff4e00;">我要登录</a></span><br/>
                </td>
              </tr>
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;姓名 &nbsp;</td>
                <td><input type="text"  value="${easybuy_user.userName}" name="userName" class="l_user" />
                <fm:errors path="userName"></fm:errors>
                </td>
              </tr>
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;用户名 &nbsp;</td>
                <td><input type="text" id="zh" value="${easybuy_user.loginName}" name="loginName" class="l_user" />
                 <fm:errors path="loginName"></fm:errors>
                </td>
              </tr>
              <tr height="50">
                <td align="right"></font><font color="#ff4e00">*</font>&nbsp;密码 &nbsp;</td>
              ...
              <tr height="50">
                ...
                <fm:errors path="password2"></fm:errors>
                </td>
              </tr>
              <tr height="50">
              ...
              <tr height="60">
              	<td>&nbsp;</td>
                <td><input type="submit" id="zcbtn" value="立即注册" class="log_btn" /></td>
              </tr>
            </table>
            </fm:form>
        </div>
